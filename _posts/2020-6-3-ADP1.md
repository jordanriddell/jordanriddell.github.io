...
Any line with # is comment, rest is entered at end of directory and after the >. First, make sure pip has been installed on your device, then enter the following in your command prompt. 
