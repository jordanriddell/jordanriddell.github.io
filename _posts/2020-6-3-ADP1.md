...
This post will detail how to use Windows command prompts and Python to scrape Twitter data for a single user account and then explain how to organize and visualize retweet and favorite data for three different types of Dallas Police Department tweets. The goal is to compare the retweet and like distribution for these different types of tweets to try and understand how the public receives them
...
The presence of two well performing tweets makes it hard to really see how the rest of DPD's homicide related tweets are received. Removing those and then 
